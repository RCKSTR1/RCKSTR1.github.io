...
author: rckstr
preview-content: En este post comenzaremos a crear una aplicación para registrar y monitorear un registro personal de niveles de glucosa en la sangre, esas mediciones que deben tomarse regularmente los pacientes de diabetes.
---
...
ng add @angular/material
    ...
    <div class="row">
        <div class="6u 12u$(small)">
            <span class="image fit"><a href="/images/blog/GLTrack1/04-MoveMaterialModules.png"
                    target="_blank"><img src="/images/blog/GLTrack1/04-MoveMaterialModules.png"
                        alt="" /></a></span>
        </div>
        <div class="6u 12u$(small)"><span class="image fit"><a
                    href="/images/blog/GLTrack1/05-CustomMaterialModule.png" target="_blank"><img
                        src="/images/blog/GLTrack1/05-CustomMaterialModule.png" alt="" /></a></span>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="6u 12u$(small)"><span class="image fit"><a
                    href="/images/blog/GLTrack1/06-ImportMaterialModule.png" target="_blank"><img
                        src="/images/blog/GLTrack1/06-ImportMaterialModule.png" alt="" /></a></span>
        </div>
    </div>
...
ng generate component components/registro
        ...
        <div class="6u 12u$(small)"><span class="image fit"><a
                    href="/images/blog/GLTrack1/07-CreateComponents.png" target="_blank"><img
                        src="/images/blog/GLTrack1/07-CreateComponents.png" alt="" /></a></span>
        </div>
    </div>
...
&lt;/app-nav&gt;
    ...
    <p style="text-align:center !important;">
        <span class="image"><a href="/images/blog/GLTrack1/13-NavComponentImplementation.png"
                target="_blank"><img src="/images/blog/GLTrack1/13-NavComponentImplementation.png"
                    alt="" /></a></span>
    </p>
...
export class NavComponent {
    ...
    ...
        ...
        <div class="5u 12u$(small)"><span class="image fit"><a
                    href="/images/blog/GLTrack1/15-MenuOptionsArray.png" target="_blank"><img
                        src="/images/blog/GLTrack1/15-MenuOptionsArray.png" alt="" /></a></span>
        </div>
    </div>
